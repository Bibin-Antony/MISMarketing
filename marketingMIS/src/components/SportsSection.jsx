...
import football from "../assets/images/FootballGround.jpg";
import basketball from "../assets/images/basketball.jpg";
import tennies from "../assets/images/tennies.jpg";
...
const SportsFacilitiesSection = () => {
  const sportsFacilities = [
    ...
    },
    {
      ...
      bgColor: "bg-[#2A9D8F]",
      textColor: "text-white",
      imageSrc: "/api/placeholder/400/240" // Replace with actual image path
    },
    {
      icon: "🏃",
